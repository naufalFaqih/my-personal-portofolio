...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      <div>
        <Image src={assets.profil_naufal} alt="profile" className="rounded-full w-32" />
      </div>
      <h3 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
        Hi! I'm Naufal Faqih <image src={assets.hand_icon} alt="hand_icon" className="rounded-full w-6" />
      </h3>
      <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Machine Learning Enthusiast</h1>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        ...
        <a href="/resume-naufal.pdf" download className="px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2">
