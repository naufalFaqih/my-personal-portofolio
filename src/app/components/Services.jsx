...
const Services = () => {
  return (
    <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I focus on web application development, machine learning, and AI integration to build digital solutions that are structured, useful, and relevant to user needs.</p>
      <div className="grid grid-cols-auto gap-6 my-10">
        {serviceData.map(({ icon, title, description, link }, index) => (
          <div key={index} className="border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            ...
            <p className="text-sm text-gray-600 leading-5 dark:text-white/80 text-justify">{description}</p>
